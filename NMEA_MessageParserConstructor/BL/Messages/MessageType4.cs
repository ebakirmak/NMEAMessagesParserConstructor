    ...
    public class MessageType4 : RootMessages
    {
        ...
        public override string[] Parser(string message)
        {
            try
            {
                ...
                this.Sotdma.subMessage.SlotOffset = Convert.ToInt32(getDecimalFromBinary(content, 154, 8));
        ...
        public override List<Tuple<string, string>> getAttributes()
        {
            ...
            List<Tuple<string, string>> _attributes = new List<Tuple<string, string>> {
                  ...
                  new Tuple<string, string>("UtcSecond",this.UtcSecond.ToString()),
                  ...
                  new Tuple<string, string>("TOEPFD",this.TOEPFD.ToString()),
                  new Tuple<string, string>("Broadcast Message",this.TCFLRBM.ToString()),
